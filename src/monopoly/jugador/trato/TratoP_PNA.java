...
public class TratoP_PNA extends Trato {
    ...
    public TratoP_PNA(Jugador interesado, Jugador benefactor, Propiedad propInteresado, Propiedad propAceptador, int turnos) {
    ...
    public void aceptar() throws ErrorComandoFortuna, ErrorFatalLogico {
        ...
        j1.anadirNoAlquiler(propAceptador, turnos);
    }
